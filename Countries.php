...
class Countries {
  ...
  /**
   * Search a country using the Country key.
   *
   * @param string $key
   *    The country key.
   * @return string
  ...
  /**
   * Search a country using the country name.
   *
   * @param string $value
   *   The country name.
   *
  ...
  /**
   * Get the number of countries availables.
   *
   * @return int
   */
  ...
  /**
   * Filter the country list using a string.
   *
   * @param string $search
